...
public class MapsActivity5 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng toronto4 = new LatLng(43.667725, -79.394684);
        mMap.addMarker(new MarkerOptions().position(toronto4).title("Marker in Toronto"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(toronto4, 15));
    }
}